...
const Memorandum = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            await ApiCall("/api/v1/memorandum", isEditing ? "PUT" : "POST", newsData, null, true);
            fetchNews();
            closeModal();
        } catch (error) {
    ...
    const handleDeleteNews = async (id) => {
        try {
            await ApiCall(`/api/v1/memorandum/${id}`, "DELETE", null, null, true);
            fetchNews();
        } catch (error) {
    ...
    return (
        <div>
                ...
                <div className="overflow-x-auto lg:p-10 pb-2 pt-4">
                    <table className="min-w-full table-auto border-collapse border border-gray-300">
                        ...
                        <tr className="bg-gray-200">
                            ...
                            <th className="border border-gray-300 px-4 py-2">Memorandum sarlavhasi</th>
                            <th className="border border-gray-300 px-4 py-2">Memorandum file</th>
            ...
            <Rodal width={500} height={400} visible={modalIsOpen} onClose={closeModal}>
                <h2 className="text-2xl mb-4">{isEditing ? "Memorandum Tahrirlash" : "Memorandum qo'shish"}</h2>
                <form onSubmit={handleFormSubmit}>

                    <div className="mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-2">Memorandum Sarlavhasi</label>
                        <input
                            type="text"
                            name="title"
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-2">Memorandum (.pdf)</label>
                        <input
                            type="file"
                            name="mainImage"
