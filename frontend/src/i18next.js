  ...
  uz: {
    translation: {
      ...
      korusel: {
        ...
        text7: "bo’lib o’tdi.",
        text8: "Buxoro xalqaro universitetida 2025-2026 o'quv yili uchun qabul jarayonlari boshlandi!",
        text9: "Ariza qoldirish",
        text10: "Amaliyot, ishga joylashish, zamonaviy sharoitlar va chet ellik ustozlardan ta’lim olish imkoniyati yaratilgan.",
      },
    },
  },
  ru: {
    translation: {
      ...
      korusel: {
        ...
        text7: "состоялась.",
        text8: "В Бухарском Международном Университете начался прием на 2025–2026 учебный год!",
        text9: "Оставить заявку",
        text10: "Созданы условия для практики, трудоустройства, современного обучения и получения знаний от иностранных преподавателей.",
  ...
  en: {
    translation: {
      ...
      korusel: {
        ...
        text7: "took place.",
        text8: "Admissions for the 2025–2026 academic year have started at Bukhara International University!",
        text9: "Apply Now",
        text10: "Opportunities for internships, employment, modern facilities, and learning from international professors are provided.",
