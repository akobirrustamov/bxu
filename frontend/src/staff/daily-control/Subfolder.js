    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const requestData = {
                ...
                dailyControlSubFolder: { id: subfolderId }
            };
            ...
            if (response.error === false && response.data) {
                if (currentContent) {
                    setContents(contents.map(content =>
                        content.id === currentContent.id ? response.data : content
                    ));
                } else {
                        ...
                        >
                            <div className="bg-white rounded-lg">
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-4">
                                        <label className="block text-gray-700 mb-1">Google Docs/Sheets Link</label>
                                        <input
                                            type="text"
                                            name="linkToFile"
                                            className="w-full p-2 border rounded"
                                    ...
                                    <div className="mb-4">
                                        <label className="block text-gray-700 mb-1">Or Upload File</label>
                                        <input
                                            type="file"
                                            name="file"
                                            className="w-full p-2 border rounded"
