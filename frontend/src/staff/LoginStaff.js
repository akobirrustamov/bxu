                ...
                <div className="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
                    <div>
                        ...
                        <div className="items-center gap-12 lg:flex justify-center">
                            ...
                            <div
                                className="relative w-1/2 rounded-3xl border my-2 border-gray-100 bg-white p-4 shadow-2xl shadow-gray-600/10 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none sm:p-8">
                                ...
                                <form onSubmit={handleAdminSubmit} className="mt-4 p-10 pt-0">
                                    <div>
                                        <h2 className={"text-center text-xl font-bold"}>Mobil platforma</h2>
                                        <label htmlFor="phone"
                                               className="my-2 mb-2 block text-gray-600 dark:text-gray-300"> Login <span
