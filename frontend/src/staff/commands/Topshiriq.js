        ...
        <div className="flex ">
            ...
            >
                ...
                <div className="text-[#09025E96] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-2 transition-all duration-500">
                    ...
                    {rank[0]?.name !== 'Rektor' && (
                        <div style={{ backgroundImage: `url(${bbg})`, }} className="bg-cover bg-white p-6 rounded-lg shadow-md hover:shadow-lg transform transition hover:scale-100 cursor-pointer">
