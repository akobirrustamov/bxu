...
const LoginStudent = () => {
    ...
    const handleAdminSubmit = async (e) => {
        ...
        try {
            const response = await ApiCall('/api/v1/auth/login', 'POST', adminData, null, false);
            ...
            if (roles[0].name === "ROLE_GENERATOR" && response.error===false) {
                    ...
                    <div>
                        ...
                        <div className="items-center gap-12 lg:flex justify-center">
                            <div className="md:mx-auto mt-0 lg:ml-0 lg:w-1/2">
                                <img className="mt-12 md:mx-auto lg:mt-0 lg:ml-0 lg:w-full" src={logoLogin}
                                     alt="tailus stats and login components" width="1865" height="1750" />
                            </div>
                            <div
